...
const projectsList = [
  {
    ...
    image: (
      <StaticImage
        ...
        src="../../assets/images/screenshots/pop.png"
        alt={'Pop! Funding'}
        loading="lazy"
      />
    ),
    imageMobile: (
      <StaticImage
        ...
        src="../../assets/images/screenshots/pop-mobile.jpg"
        alt={'Pop! Funding'}
        loading="lazy"
      />
    ),
  },
  {
    ...
    image: (
      <StaticImage
        placeholder="blurred"
        className={styles.image}
        src="../../assets/images/screenshots/nt.png"
    ...
    imageMobile: (
      <StaticImage
        placeholder="blurred"
        className={styles.imageMobile}
        src="../../assets/images/screenshots/nt-mobile.jpg"
        alt={'Naturalmente Tecnologici'}
        style={{opacity: 0.3}}
        loading="lazy"
      />
  ...
  },
  {
    ...
    image: (
      <StaticImage
        placeholder="blurred"
        className={styles.image}
        src="../../assets/images/screenshots/wdc.png"
    ...
    imageMobile: (
      <StaticImage
        placeholder="blurred"
        className={styles.imageMobile}
        src="../../assets/images/screenshots/wdc-mobile.jpg"
        alt={'Web Dev Challenge 2022'}
        loading="lazy"
      />
    ),
